...
public class Day02 {
    ...
    public static void main(String[] args) throws IOException {
        int[] originalNums = Stream.of(AdventOfCodeHelper.getFileAsString().split(",")).mapToInt(Integer::valueOf).toArray();
        ...
        System.out.printf("Part2 solution is %s %n", solveDay2(part2Nums));
    }
    ...
    private static String solveDay2(int[] originalNums) {
